...
import com.convenience.store.global.security.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/schedule/my").hasAnyRole("MANAGER", "STAFF")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/store/location").hasAnyRole("MANAGER", "STAFF")
                        .requestMatchers("/api/store/**").hasRole("MANAGER")
